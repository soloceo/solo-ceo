-- ══════════════════════════════════════════════════════════════════════
-- Supabase PostgreSQL schema for 一人CEO
-- Mirrors the SQLite schema from server.ts / api.ts with:
--   • user_id UUID for multi-tenant RLS
--   • updated_at for sync conflict resolution
--   • soft_deleted for cross-device delete propagation
-- ══════════════════════════════════════════════════════════════════════
...
-- ── CLIENT SUBSCRIPTION LEDGER (computed) ─────────────────────────
...
-- ══════════════════════════════════════════════════════════════════════
-- ENABLE REALTIME for mutable tables
-- ══════════════════════════════════════════════════════════════════════
