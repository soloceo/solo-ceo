 ...
 *   .sidebar-glass, .ai-chat-panel — sets `--mx` / `--my` (0-100%) while
 *                                    hovered (radial spotlight + border glow)
 *
 * Guards:
...
const SPOTLIGHT_SEL = ".card-interactive, .card-glow, .stat-card, .widget-card, .nav-glow, .sidebar-glass, .ai-chat-panel";
