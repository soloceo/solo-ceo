  ...
  return (
    <div className="mobile-page max-w-[960px] mx-auto min-h-full flex flex-col px-4 py-3 md:px-6 md:py-4 lg:px-8 lg:py-5 relative">
      ...
      {showAll && createPortal(
        <div className="fixed inset-0 flex flex-col" role="dialog" aria-modal="true" aria-label="All transactions" style={{ zIndex: 700, background: "var(--color-bg-primary)", paddingBottom: "max(env(safe-area-inset-bottom, 0px), 8px)" }}>
            {/* Header */}
