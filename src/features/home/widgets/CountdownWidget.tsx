  ...
  return (
    <div className="group flex items-center w-full press-feedback relative" style={{ minHeight: s(22), gap: s(6) }}>
      ...
      <button
        ...
        className="opacity-0 group-hover:opacity-100 transition-opacity shrink-0 press-feedback p-0.5 rounded-full"
  ...
  return (
    <div className="group flex flex-col items-center justify-center flex-1 relative w-full">
      ...
      <button
        ...
        className="absolute top-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity press-feedback p-0.5 rounded-full"
        style={{ color: "var(--color-text-quaternary)" }}
      >
        <X size={s(9)} />
      </button>
