export const common = {
  ...
  "app.quickCreate.task": "New Work Task",
  "app.quickCreate.personalTask": "New Personal Todo",
  "app.quickCreate.lead": "Add Lead",
  "app.quickCreate.client": "Add Client",
  "app.quickCreate.bizFinance": "Log Biz Finance",
  "app.quickCreate.personalFinance": "Log Personal Expense",
