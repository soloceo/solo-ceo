...
export const AGENT_TEMPLATES: AgentTemplate[] = [
  /* ─────────────────── AI Assistant (Default) ─────────────────── */
  {
    ...
    tools: ['create_task', 'update_task', 'delete_task', 'create_lead', 'move_lead', 'update_lead', 'record_transaction', 'create_client', 'update_client', 'search_data', 'web_search'],
    starters: {
      zh: [
  ...
  /* ─────────────────────────── Sales Agent ─────────────────────────── */
  {
    ...
    tools: ['create_lead', 'move_lead', 'update_lead', 'create_client', 'update_client', 'search_data', 'web_search'],
    starters: {
      zh: [
  ...
  /* ────────────────────────── Task Manager ─────────────────────────── */
  {
    ...
    tools: ['create_task', 'update_task', 'delete_task', 'search_data'],
    starters: {
      zh: [
  ...
  /* ─────────────────────────── Finance Agent ─────────────────────────── */
  {
    ...
    tools: ['record_transaction', 'search_data'],
    starters: {
      zh: [
